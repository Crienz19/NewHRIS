...
@section('title', 'Supervisor | OT Disapproved')
        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="ot-disapproved-table" class="table table-striped table-bordered">
                        <thead>
                            <th>#</th>
                            <th>Employee</th>
                            <th>Position</th>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            var dt = $('#ot-disapproved-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/tl/otRequests/") }}/Disapproved',
                'dom': 'tp',
                'columns': [
                    { data: 'id', name: 'id' },
