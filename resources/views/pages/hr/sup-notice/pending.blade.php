        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-theme btn-block" id="btn-acknowledged">Acknowledged</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var dt = $('#notice-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/hr/noticeRequests") }}/Pending/supervisor',
                'dom': 'tp',
                'columns': [
            ...
            $('#btn-acknowledged').click(function() {
                $.ajax({
                    type: 'ajax',
                    url: `{{ url("/hr/noticeRequest/acknowledged") }}/${id}`,
                    method: 'post',
                    dataType: 'json',
                    success: function(response) {
                        console.log(response);
