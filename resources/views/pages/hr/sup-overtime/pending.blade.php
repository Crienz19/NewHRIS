        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="hr-ot-pending-table" class="table table-striped table-bordered">
                        <thead>
                        <th>#</th>
                        <th>Employee</th>
                        <th>Position</th>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            var dt = $('#hr-ot-pending-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/hr/otRequests") }}/Pending/supervisor',
                "iDisplayLength": 500,
                ...
                'buttons': [
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config){
                            dt.ajax.url('{{ url("/hr/otRequests") }}/Pending').load();
                        }
                    }
                ],
                'columns': [
            ...
            var id;
            $('#hr-ot-pending-table tbody').on('click', 'td button', function (){
            ...
            $('#btn-decline').click(function() {
                ...
                $.ajax({
                    type: 'ajax',
                    url: '{{ url("/hr/otRequest/disapproved") }}/' + id,
                    method: 'post',
                    data: formData,
                    dataType: 'json',
                    processData: false,
