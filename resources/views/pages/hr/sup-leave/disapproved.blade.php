...
@section('title', 'HR | Leave Disapproved')
        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="hr-leave-disapproved-table" class="table table-striped table-bordered">
                        <thead>
                        <th>#</th>
                        <th>Employee</th>
                        <th>Position</th>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            var dt = $('#hr-leave-disapproved-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/hr/leaveRequests") }}/Disapproved/supervisor',
                "iDisplayLength": 500,
                ...
                'buttons': [
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config){
                            dt.ajax.url('{{ url("/hr/leaveRequests") }}/Pending/supervisor').load();
                        }
                    }
                ],
                'columns': [
            ...
            var id;
            $('#hr-leave-disapproved-table tbody').on('click', 'td button', function (){
