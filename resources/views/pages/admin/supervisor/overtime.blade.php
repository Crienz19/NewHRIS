...
@section('title', 'Admin | Supervisor Overtime')
        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="supervisor-ot-table" class="table table-striped table-bordered">
                        <thead>
                        <th>Employee</th>
                        <th>Position</th>
                        <th>Department</th>
...
@section('script')
    <script>
        $(document).ready(function() {
            var dt = $('#supervisor-ot-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("admin/otRequests") }}/supervisor/Pending',
                ...
                'buttons': [
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config){
                            dt.ajax.url('{{ url("admin/otRequests") }}/supervisor/Pending').load();
                        }
                    }
                ],
                'columns': [
            ...
            $('#supervisor-ot-table tbody').on('click', 'td button', function() {
            ...
            $('#btn-filter').click(function() {
                ...
                dt.api().ajax.url('{{ url("admin/otRequests") }}/supervisor/'+ status +'').load();
            });
        });
    </script>
@endsection