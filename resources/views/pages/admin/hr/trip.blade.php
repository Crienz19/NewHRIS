        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="hr-trip-table" class="table table-striped table-bordered">
                        <thead>
                        <th>#</th>
                        <th>Employee</th>
                        <th>Position</th>
...
@section('script')
    <script>
        $(document).ready(function() {
            var dt = $('#hr-trip-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/admin/tripRequests") }}/hr/Pending',
                ...
                'buttons': [
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config){
                            dt.ajax.url('{{ url("admin/tripRequests") }}/hr/Pending').load();
                        }
                    }
                ],
                'columns': [
            ...
            $('#hr-trip-table tbody').on('click', 'td button', function (){
            ...
            $('#hr-filter').click(function() {
                var status = $('select[name=status]').val();
                dt.api().ajax.url('{{ url("admin/tripRequests") }}/hr/'+ status +'').load();
            });
        });
    </script>
@endsection