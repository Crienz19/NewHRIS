...
@section('title', 'Admin | HR Overtime')
        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="hr-ot-table" class="table table-striped table-bordered">
                        <thead>
                        <th>#</th>
                        <th>Employee</th>
                        <th>Position</th>
...
@section('script')
    <script>
        $(document).ready(function() {
            var dt = $('#hr-ot-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("admin/otRequests") }}/hr/Pending',
                ...
                'buttons': [
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config){
                            dt.ajax.url('{{ url("admin/otRequests") }}/hr/Pending').load();
                        }
                    }
                ],
                'columns': [
            ...
            $('#hr-ot-table tbody').on('click', 'td button', function() {
            ...
            $('#btn-filter').click(function() {
                ...
                dt.api().ajax.url('{{ url("admin/otRequests") }}/hr/'+ status +'').load();
            });
        });
    </script>
@endsection