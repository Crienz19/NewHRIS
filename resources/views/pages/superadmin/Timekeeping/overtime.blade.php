...
@section('title', 'Superadmin | Overtime Requests')
        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="ot-request-table" class="table table-striped table-bordered">
                        <thead>
                            <th>#</th>
                            <th>Employee</th>
                            <th>Position</th>
...
@section('script')
    <script>
        $(document).ready(function() {
            var dt = $('#ot-request-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/superadmin/overtime") }}',
                'dom': 'tp',
                'columns': [
                    { data: 'id', name: 'id' },
            ...
            $('#ot-request-table tbody').on('click', 'td button', function() {
                ...
                switch (data) {
                    case 'view':
                        $.ajax({
                            type: 'ajax',
                            url: '{{ url("/superadmin/overtime/single") }}/' + dataId,
                            method: 'get',
                            dataType: 'json',
