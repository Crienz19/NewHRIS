...
@section('title', 'Supervisor | Leave Disapproved')
        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="tl-leave-disapproved-table" class="table table-striped table-bordered">
                        <thead>
                        <th>#</th>
                        <th>Employee</th>
                        <th>Position</th>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            var dt = $('#tl-leave-disapproved-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/tl/leaveRequests") }}/Disapproved',
                'dom': 'tp',
                'columns': [
                    { data: 'id', name: 'id' },
            ...
            $('#tl-leave-disapproved-table tbody').on('click', 'td button', function (){
