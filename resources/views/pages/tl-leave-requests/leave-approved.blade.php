...
@section('title', 'Supervisor | Leave Approved')
        ...
        <div class="col-md-12">
            <div class="content-panel">
                <div class="panel-body">
                    <table id="tl-leave-approved-table" class="table table-striped table-bordered">
                        <thead>
                        <th>#</th>
                        <th>Employee</th>
                        <th>Position</th>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            var dt = $('#tl-leave-approved-table').dataTable({
                'processing': true,
                'serverSide': true,
                'ajax': '{{ url("/tl/leaveRequests") }}/Approved',
                'dom': 'tp',
                'columns': [
                    { data: 'id', name: 'id' },
            ...
            var id;
            $('#tl-leave-approved-table tbody').on('click', 'td button', function (){
                ...
                switch (data) {
                    case 'view':
                        $.ajax({
                            type: 'ajax',
                            url: `{{ url("/tl/leaveRequests/view") }}/${id}`,
                            method: 'get',
                            dataType: 'json',
