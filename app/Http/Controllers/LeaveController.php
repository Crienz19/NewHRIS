...
class LeaveController extends Controller
{
    ...
    public function storeLeave(Request $request)
    {
        ...
        $data = [
            ...
            'time_from'                  =>  ($request->input('leave-type') == 'VL-Half' || $request->input('leave-type') == 'PTO-Half' || $request->input('leave-type') == 'SL-Half') ? date('h:i A', strtotime($request->input('time-from'))) : '',
            'time_to'                    =>  ($request->input('leave-type') == 'VL-Half' || $request->input('leave-type') == 'PTO-Half' || $request->input('leave-type') == 'SL-Half') ? date('h:i A', strtotime($request->input('time-to'))) : '',
            'remarks'                    =>  '',
